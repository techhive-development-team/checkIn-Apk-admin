  ...
  return (
    <div className="relative flex flex-col min-h-screen bg-slate-50 overflow-hidden">
      ...
      <div className="flex items-center justify-center grow relative z-10 px-4 py-10 sm:py-12 md:py-16">
        <div className= "w-full max-w-md sm:max-w-lg md:max-w-xl bg-white/50 backdrop-blur-lg border border-white/30 rounded-2xl sm:rounded-3xl shadow-[0_20px_80px_rgba(15,23,42,0.08)] px-5 sm:px-7 md:px-8 py-7 sm:py-9 md:py-10" >

          <div className="flex justify-center mb-3 items-start">
            <span className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-sky-600 text-center">
              CheckIn+
            </span>
          </div>

          <div className="flex justify-center mb-8 sm:mb-10 md:mb-8 text-center">
            ...
            <form onSubmit={methods.handleSubmit(onSubmit)}>
              <div className="space-y-5 sm:space-y-6 md:space-y-7">
                ...
                <Button
                  ...
                  className="mt-2 mb-2 w-full h-10 sm:h-11 md:h-12 text-sm sm:text-sm md:text-base cursor-pointer"
                />
                ...
                <Button
                  ...
                  className="cursor-pointer flex items-center justify-center gap-2 border border-gray-300 bg-gray-100! text-black! hover:bg-gray-300! w-full h-10 sm:h-11 md:h-12 text-sm sm:text-sm md:text-base"
                  onClick={() => {
