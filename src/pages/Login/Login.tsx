    ...
    <div className="min-h-screen flex">
      <div className="w-full md:w-3/5 flex flex-col justify-center bg-white min-h-screen">
        <div className="w-full max-w-lg md:max-w-xl lg:max-w-2xl px-8 mx-auto">
            ...
            <form onSubmit={onSubmit}>
              <div className="space-y-7">
                ...
                <Button
                  ...
                  className="mt-2 flex items-center justify-center gap-2 border border-gray-300 bg-gray-100! text-black! hover:bg-gray-300!"
                  onClick={() => {
          ...
          <div className=" text-center py-3 text-black mt-6 text-medium ">
      ...
      <div className="  w-2/5 from-red-500 to-red-400">
        <img src={harry} alt="harry" className="h-full object-fit" />
      </div>
    </div>
  );
};
